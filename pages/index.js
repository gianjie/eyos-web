...
export default function Home({records}) {
  ...
  const filterRecordsLength = filterRecords.length;
    ...
    <div className={styles.padding}>
      ...
      {filterRecordsLength > 0 && 
        <div style={{
          ...
          <span style={{width:'100%', color:'red', fontWeight:500, fontSize: 14}}>{filterRecordsLength} Stores are awaiting approval</span>
